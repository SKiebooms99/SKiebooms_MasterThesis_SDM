...
values(Dryopteris_LGM_HorsGlacier)[values(Dryopteris_LGM_HorsGlacier)<= 0] = 0 #ne garder que les présences (les valeurs=1, les autres =0)
...
MigrationAlt_Pres_LGM # -0,02 m/an soit 2m par décennie
...
# Chargement des coordonnées des centroides (calculées dans QGIS):
